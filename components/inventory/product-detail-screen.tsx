...
const details: Record<string, DetailProduct> = {
  ...
  'cat-food': { ...inventoryProducts[0], name: 'Ziwi Peak Air-Dried', brand: 'Ziwi Peak', specification: '1kg · 风干猫粮', quantity: 3, unit: '包', statusLabel: '3包 · 1已开', openedDate: '2026/09/01', expectedDays: 30, remaining: 58, history: ['9/15 · 开袋', '9/01 · 入库 +2'], expiryRows: [{ date: '2027/04/16', quantity: 2, tone: 'safe' }] },
}
...
export function ProductDetailScreen({ id }: { id: string }) {
  ...
  const isProgress = Boolean(product.progress)
